...
export interface SaveState {
  ...
  /** Trophy art by award name, from the same pass that indexes the faces. */
...
const blank: SaveState = {
  ...
  faces: null, facePaths: {}, facesBusy: false, schoolArt: {}, schoolColors: {}, awardArt: {},
  schoolArtMissing: [],
}
